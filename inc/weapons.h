...
{WEAPON_PISTOL, 		"PISTOL", 		9, 		1, 1.0f, 	3.0f, 	30, 	0.9f, "./ui/pistol/"},
{WEAPON_RIFLE, 			"RIFLE", 		30, 	1, 1.0f,  	3.0f, 	70, 	0.8f, "./ui/rifle/"},
{WEAPON_MACHINE_GUN, 	"MACHINE GUN", 	100, 	10, 1.0f, 	3.0f, 	50, 	0.5f, "./ui/machine-gun/"},
//sentinel
