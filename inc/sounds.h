...
# define LEVEL_CLEARED_SYSTEM_CALL         "aplay sounds/gong.wav > /dev/null 2>&1 &"
...
# define PISTOL_ATTACK_SOUND               "aplay ui/pistol/attack.wav > /dev/null 2>&1 &"
...
# define BUBBLE_POP_SOUND                   "aplay sounds/bubble-pop.wav > /dev/null 2>&1 &"
