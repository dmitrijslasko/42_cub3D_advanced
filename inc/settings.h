...
// default scale
# define KEYBOARD_PLAYER_STEP_FORWARD		0.02f
# define KEYBOARD_PLAYER_STEP_BACKWARD		0.01f
# define KEYBOARD_PLAYER_STEP_SIDE 			0.01f

# define KEYBOARD_PLAYER_ROTATION_STEP 		1.0f
# define KEYBOARD_VERTICAL_LOOK_STEP        20.0f
# define MOVE_SPEED_MULTIPLIER_SLOW 		0.3f
# define MOVE_SPEED_MULTIPLIER_FAST			1.1f
